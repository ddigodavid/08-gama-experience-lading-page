 ...
 * Generated for Laravel 5.2.45 on 2017-07-06.
 *
...
if (! function_exists('with')) {
    ...
    class Artisan extends \Illuminate\Support\Facades\Artisan{
        ...
        public static function handle($input, $output = null){
            ...
            return \Vinci\App\Core\Console\Kernel::handle($input, $output);
        }
        ...
        public static function terminate($input, $status){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            \Vinci\App\Core\Console\Kernel::terminate($input, $status);
        }
        ...
        public static function registerCommand($command){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            \Vinci\App\Core\Console\Kernel::registerCommand($command);
        }
        ...
        public static function call($command, $parameters = array()){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            return \Vinci\App\Core\Console\Kernel::call($command, $parameters);
        }
        ...
        public static function queue($command, $parameters = array()){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            \Vinci\App\Core\Console\Kernel::queue($command, $parameters);
        }
        ...
        public static function all(){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            return \Vinci\App\Core\Console\Kernel::all();
        }
        ...
        public static function output(){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            return \Vinci\App\Core\Console\Kernel::output();
        }
        ...
        public static function bootstrap(){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            \Vinci\App\Core\Console\Kernel::bootstrap();
        }
    ...
    class Password extends \Illuminate\Support\Facades\Password{
        ...
        public static function broker($name = null){
            ...
            return \LaravelDoctrine\ORM\Auth\Passwords\PasswordBrokerManager::broker($name);
        }
        ...
        public static function getDefaultDriver(){
            //Method inherited from \Illuminate\Auth\Passwords\PasswordBrokerManager            
            return \LaravelDoctrine\ORM\Auth\Passwords\PasswordBrokerManager::getDefaultDriver();
        }
        ...
        public static function setDefaultDriver($name){
            //Method inherited from \Illuminate\Auth\Passwords\PasswordBrokerManager            
            \LaravelDoctrine\ORM\Auth\Passwords\PasswordBrokerManager::setDefaultDriver($name);
        }
    ...
    class Sanitizer extends \Rees\Sanitizer\Facade{
        ...
        public static function register($name, $callback){
            //Method inherited from \Rees\Sanitizer\Sanitizer            
            \Vinci\App\Core\Services\Sanitizer\Sanitizer::register($name, $callback);
        }
         ...
         * @static 
         */
        public static function sanitize($rules, $data){
            //Method inherited from \Rees\Sanitizer\Sanitizer            
            \Vinci\App\Core\Services\Sanitizer\Sanitizer::sanitize($rules, $data);
        }
         ...
         * @static 
         */
        public static function executeSanitizer($sanitizer, $parameters){
            //Method inherited from \Rees\Sanitizer\Sanitizer            
            return \Vinci\App\Core\Services\Sanitizer\Sanitizer::executeSanitizer($sanitizer, $parameters);
        }
    ...
    class Fractal extends \Spatie\Fractal\FractalFacade{
         ...
         *
         * @param \Spatie\Fractal\League\Fractal\Pagination\CursorInterface $cursor
         * @return $this 
         * @static 
         */
         ...
         * @static 
         */
        public static function resourceName($resourceName){
            return \Spatie\Fractal\Fractal::resourceName($resourceName);
        }
    ...
    class Postmon extends \Vinci\Infrastructure\Services\Postmon\Facades\Postmon{
        ...
        public static function getAddress($cep){
            return \Vinci\Infrastructure\Services\Postmon\Postmon::getAddress($cep);
        }
    ...
    class Breadcrumb extends \Vinci\App\Website\Seo\Facades\Breadcrumb{
        ...
        public static function add($title, $url = null){
            return \Vinci\App\Website\Seo\Breadcrumb::add($title, $url);
        }
         ...
         * @static 
         */
        public static function withoutHome(){
            return \Vinci\App\Website\Seo\Breadcrumb::withoutHome();
        }
         ...
         * @static 
         */
        public static function first($title, $url = '/'){
            return \Vinci\App\Website\Seo\Breadcrumb::first($title, $url);
        }
         ...
         * @static 
         */
        public static function prepend($title, $url = null){
            return \Vinci\App\Website\Seo\Breadcrumb::prepend($title, $url);
        }
         ...
         * @static 
         */
        public static function makeItem($title, $url = null){
            return \Vinci\App\Website\Seo\Breadcrumb::makeItem($title, $url);
        }
        ...
        public static function make($callback){
            return \Vinci\App\Website\Seo\Breadcrumb::make($callback);
        }
        ...
        public static function getItems(){
            return \Vinci\App\Website\Seo\Breadcrumb::getItems();
        }
         ...
         * @static 
         */
        public static function render($render = null){
            return \Vinci\App\Website\Seo\Breadcrumb::render($render);
        }
        ...
        public static function from($entity){
            return \Vinci\App\Website\Seo\Breadcrumb::from($entity);
        }
        ...
        public static function getIterator(){
            return \Vinci\App\Website\Seo\Breadcrumb::getIterator();
        }
